...
#include "StoneyDSP/Biquads/DSP/Biquads.hpp"
...
template <typename SampleType>
void Biquads<SampleType>::setFilterType(Biquads<SampleType>::FilterType newFiltType)
{
...
template <typename SampleType>
void Biquads<SampleType>::setTransformType(Biquads<SampleType>::TransformationType newTransformType)
{
...
void Biquads<SampleType>::coefficients()
{
    ...
    switch (filtType)
    {
    case Biquads::FilterType::lowPass2:
    ...
    case Biquads::FilterType::lowPass1:
    ...
    case Biquads::FilterType::highPass2:
    ...
    case Biquads::FilterType::highPass1:
    ...
    case Biquads::FilterType::bandPass:
    ...
    case Biquads::FilterType::bandPassQ:
    ...
    case Biquads::FilterType::lowShelf2:
    ...
    case Biquads::FilterType::lowShelf1:
    ...
    case Biquads::FilterType::lowShelf1C:
    ...
    case Biquads::FilterType::highShelf2:
    ...
    case Biquads::FilterType::highShelf1:
    ...
    case Biquads::FilterType::highShelf1C:
    ...
    case Biquads::FilterType::allPass:
