...
+ Under construction!
+ Currently only implementing 12dB low pass, high pass, and band pass using variable BiLinear transforms, processing precision, and oversampling to achieve high-quality results (much more to come)!
