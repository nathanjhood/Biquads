...
#define STONEYDSP_BIQUADS_DSP_BIQUADS_HPP
...
public:
    ...
    void setFilterType(Biquads::FilterType newFiltType);

    /** Sets the BiLinear Transform for the filter to use. See enum for availa ble types. */
    void setTransformType(Biquads::TransformationType newTransformType);
...
private:
    ...
    Biquads::FilterType filtType = Biquads::FilterType::lowPass2;
    Biquads::TransformationType transformType = Biquads::TransformationType::directFormIItransposed;
